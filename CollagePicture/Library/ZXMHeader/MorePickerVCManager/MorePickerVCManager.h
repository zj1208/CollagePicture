...
@protocol MorePickerVCManagerDelegate <NSObject>

@optional
/**
 *  MorePickerVCManager的协议,拍照返回的一张照片回调代理；
 *
...
@interface MorePickerVCManager : NSObject<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>

@property(nonatomic, weak) id<MorePickerVCManagerDelegate>morePickerActionDelegate;
