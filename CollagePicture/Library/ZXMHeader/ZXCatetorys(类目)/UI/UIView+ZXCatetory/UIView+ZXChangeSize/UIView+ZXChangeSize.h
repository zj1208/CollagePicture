...
当视图在屏幕上可见时，该guide反映了视图中navigationBar导航栏、tabBars选项卡栏、toolbars工具栏和其他祖先视图未覆盖的部分。如果当前视图还没有安装在视图层次结构中，或者在屏幕上还不可见，则layoutGuide边缘与视图边缘相等,self.view.frame = self.view.safeAreaLayoutGuide.layoutFrame。
 以iPhoneX{{0, 0}, {414, 896}}为例，UIViewController的view在屏幕上可见时：1.导航条半透明，有tab的时候，layoutFrame = {{0, 88}, {414, 725}}; 2.导航条不透明，有tab的时候，layoutFrame = {{0, 0}, {414, 725}}; 3.没导航条，也没有tabController的tab时候，layoutFrame = {{0, 0}, {414, 896}}
*/
