...
+ (NSString *)zhuDate_showTime:(NSTimeInterval) msglastTime showDetail:(BOOL)showDetail
{
    ...
    result = [NSString zhuDate_getPeriodOfTime:hour withMinute:msgDateComponents.minute];
    if (hour > 12)
    {
        hour = hour - 12;
    }
    ...
    {
        NSString *weekDay = [NSString zhuDate_WeekdayStr:msgDateComponents.weekday];
