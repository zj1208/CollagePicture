...
@interface TableViewUnfoldFooterView : UITableViewHeaderFooterView
...
- (void)addFooterView
{
    TableViewUnfoldFooterView *footerView = [TableViewUnfoldFooterView xm_viewFromNib];
